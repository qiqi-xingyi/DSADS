...
class LoadImages:  # for inference 用作推理
    def __init__(self, path, img_size=640):
        p = str(Path(path))  # os-agnostic 未知目录
        p = os.path.abspath(p)  # absolute path 绝对目录
        if '*' in p:
...
###############################################################################################################
    # class LoadImages_1:  # 用作推理 , 放弃冗余目录及视频处理，改写为仅对单张图片处理
