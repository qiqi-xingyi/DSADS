...
class Ui_MainWindow(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        # self.lz = utils.utils.load_entire_model( 'deeplabv3p_resnet101_os8_cityscapes_1024x512_80k.yml' , './models/model2.pdparams')
    ...
    def show_camera(self):
        ...
        # self.image = self.cv2.imread("data/room/shiyanshi.jpg")
        ...
        ######################################################################################################
        #画线
        cv2.line(self.out_img, pt1=(200, 290), pt2=(440 , 290), color=(0, 255, 0), thickness=10)

        cv2.line(self.out_img, pt1=(580, 480), pt2=(440 , 290), color=(0, 0, 255), thickness=10)

        cv2.line(self.out_img, pt1=(60, 480), pt2=(200 , 290), color=(0, 0, 255), thickness=10)
