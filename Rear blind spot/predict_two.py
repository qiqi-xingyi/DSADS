...
#             crop_size=None):
    ...
    #predict(self.model, self.image, self.cfg)
    ##im直接通过传参赋值
def predict(model , image , cfg ):
    ...
    with paddle.no_grad():
        ...
        added_image = utils.visualize.visualize_2(image , pred, weight=0.6)# 半透明
    ...
    #     im_file = im_file[1:]
            ...
            # mkdir(added_image_path)
            # cv2.imwrite(added_image_path, added_image)
            # cv2.imwrite(r"D:\AI\PaddleSeg\ooutput"+im_file, added_image)
